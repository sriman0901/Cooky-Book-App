...
import 'package:cooky_book/screens/ChickenLollipoRecipe.dart';

class ChickenLollipop extends StatelessWidget {
  @override
                          ...
                          children:[
                            new ListTile(
                              ...
                              title: Padding(
                                ...
                                child: new Text('500 grams Chicken lollipop' ,
                                  style: TextStyle(
                                    color: Colors.white,
                                    fontSize: 20.0,
                                  ),
                            ...
                            new ListTile(
                              ...
                              title: Padding(
                                padding: const EdgeInsets.only(right: 70.0,bottom: 15.0),
                                child: new Text('1/4 cup Soy sauce' ,
                                  style: TextStyle(
                                    color: Colors.white,
                                    fontSize: 20.0,
                                  ),
                            ...
                            new ListTile(
                              ...
                              title: Padding(
                                padding: const EdgeInsets.only(right: 70.0,bottom: 15.0),
                                child: new Text('1 tbsp Tomato ketchup' ,
                                  style: TextStyle(
                                    color: Colors.white,
                                    fontSize: 20.0,
                                  ),
                            ...
                            new ListTile(
                              ...
                              title: Padding(
                                padding: const EdgeInsets.only(right: 70.0,bottom: 15.0),
                                child: new Text('1 tbsp Red chilli powder' ,
                                  style: TextStyle(
                                    color: Colors.white,
                                    fontSize: 20.0,
                                  ),
                            ...
                            new ListTile(
                              ...
                              title: Padding(
                                padding: const EdgeInsets.only(right: 70.0,bottom: 15.0),
                                child: new Text('1/4 cup Cornflour' ,
                                  style: TextStyle(
                                    color: Colors.white,
                                    fontSize: 20.0,
                                  ),
                            ...
                            new ListTile(
                              ...
                              title: Padding(
                                padding: const EdgeInsets.only(right: 70.0,bottom: 15.0),
                                child: new Text('2 tbsp All purpose flour' ,
                                  style: TextStyle(
                                    color: Colors.white,
                                    fontSize: 20.0,
                                  ),
                            ...
                            new ListTile(
                              ...
                              title: Padding(
                                padding: const EdgeInsets.only(right: 70.0,bottom: 15.0),
                                child: new Text('2 tbsp Rice flour' ,
                                  style: TextStyle(
                                    color: Colors.white,
                                    fontSize: 20.0,
                                  ),
                            ...
                            new ListTile(
                              ...
                              title: Padding(
                                padding: const EdgeInsets.only(right: 70.0,bottom: 15.0),
                                child: new Text('1 tbsp Ginger paste' ,
                                  style: TextStyle(
                                    color: Colors.white,
                                    fontSize: 20.0,
                                  ),
                            ...
                            FlatButton(
                              ...
                              onPressed: (){
                                Navigator.push(context, MaterialPageRoute(builder: (context)=>ChickenLollipopRecipe()),
                                );
                              },
                              child: Align(
                                ...
                                child: Padding(
                                  ...
                                  child: Text('Let\'s Cook Our Chicken Lollipop',
