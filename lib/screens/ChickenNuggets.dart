...
import 'package:cooky_book/screens/ChickenNuggetsRecipe.dart';

class ChickenNuggets extends StatelessWidget {
  @override
                          ...
                          children:[
                            new ListTile(
                              ...
                              title: Padding(
                                ...
                                child: new Text('1/2 cup all-purpose flour' ,
                                  style: TextStyle(
                                    color: Colors.white,
                                    fontSize: 20.0,
                                  ),
                            ...
                            new ListTile(
                              ...
                              title: Padding(
                                padding: const EdgeInsets.only(right: 70.0,bottom: 15.0),
                                child: new Text('1 teaspoon granulated garlic' ,
                                  style: TextStyle(
                                    color: Colors.white,
                                    fontSize: 20.0,
                                  ),
                            ...
                            new ListTile(
                              ...
                              title: Padding(
                                padding: const EdgeInsets.only(right: 70.0,bottom: 15.0),
                                child: new Text('Kosher salt and ground black pepper' ,
                                  style: TextStyle(
                                    color: Colors.white,
                                    fontSize: 20.0,
                                  ),
                            ...
                            new ListTile(
                              ...
                              title: Padding(
                                padding: const EdgeInsets.only(right: 70.0,bottom: 15.0),
                                child: new Text('2 boneless skinless chicken breasts, cut into 1 1/2-inch pieces' ,
                                  style: TextStyle(
                                    color: Colors.white,
                                    fontSize: 20.0,
                                  ),
                            ...
                            new ListTile(
                              ...
                              title: Padding(
                                padding: const EdgeInsets.only(right: 70.0,bottom: 15.0),
                                child: new Text('1 cup prepared breadcrumbs' ,
                                  style: TextStyle(
                                    color: Colors.white,
                                    fontSize: 20.0,
                                  ),
                            ...
                            new ListTile(
                              ...
                              title: Padding(
                                padding: const EdgeInsets.only(right: 70.0,bottom: 15.0),
                                child: new Text('1 cup vegetable oil' ,
                                  style: TextStyle(
                                    color: Colors.white,
                                    fontSize: 20.0,
                                  ),
                            ...
                            FlatButton(
                              ...
                              onPressed: (){
                                Navigator.push(context, MaterialPageRoute(builder: (context)=>ChickenNuggetsRecipe()),
                                );
                              },
                              child: Align(
                                ...
                                child: Padding(
                                  ...
                                  child: Text('Let\'s Cook Our Tasty Chicken Nuggets',
