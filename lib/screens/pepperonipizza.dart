...
import 'package:cooky_book/screens/PepperoniPizzaRecipe.dart';
                          ...
                          children:[
                            new ListTile(
                              ...
                              title: Padding(
                                ...
                                child: new Text('16 ounces pizza dough, store-bought or homemade' ,
                                  style: TextStyle(
                                    color: Colors.white,
                                    fontSize: 20.0,
                                  ),
                            ...
                            new ListTile(
                              ...
                              title: Padding(
                                padding: const EdgeInsets.only(right: 70.0,bottom: 15.0),
                                child: new Text('1/2 cup pizza sauce ' ,
                                  style: TextStyle(
                                    color: Colors.white,
                                    fontSize: 20.0,
                                  ),
                            ...
                            new ListTile(
                              ...
                              title: Padding(
                                padding: const EdgeInsets.only(right: 70.0,bottom: 15.0),
                                child: new Text('18-20 slices pepperoni' ,
                                  style: TextStyle(
                                    color: Colors.white,
                                    fontSize: 20.0,
                                  ),
                            ...
                            new ListTile(
                              ...
                              title: Padding(
                                padding: const EdgeInsets.only(right: 70.0,bottom: 15.0),
                                child: new Text('12 ounces mozzarella cheese, grated' ,
                                  style: TextStyle(
                                    color: Colors.white,
                                    fontSize: 20.0,
                                  ),
                            ...
                            new ListTile(
                              ...
                              title: Padding(
                                padding: const EdgeInsets.only(right: 70.0,bottom: 15.0),
                                child: new Text('1/2 teaspoon ground black pepper' ,
                                  style: TextStyle(
                                    color: Colors.white,
                                    fontSize: 20.0,
                                  ),
                            ...
                            new ListTile(
                              ...
                              title: Padding(
                                padding: const EdgeInsets.only(right: 70.0,bottom: 15.0),
                                child: new Text('1 teaspoon fresh oregano, optional' ,
                                  style: TextStyle(
                                    color: Colors.white,
                                    fontSize: 20.0,
                                  ),
                            ...
                            new ListTile(
                              ...
                              title: Padding(
                                padding: const EdgeInsets.only(right: 70.0,bottom: 15.0),
                                child: new Text('Flour for rolling and shaping dough' ,
                                  style: TextStyle(
                                    color: Colors.white,
                                    fontSize: 20.0,
                                  ),
                            ...
                            FlatButton(
                              ...
                              onPressed: (){
                                Navigator.push(context, MaterialPageRoute(builder: (context)=>PepperoniPizzaRecipe()),
                                );
                              },
                              child: Align(
                                ...
                                child: Padding(
                                  ...
                                  child: Text('Let\'s Cook Our Delicious Pepperoni Pizza',
